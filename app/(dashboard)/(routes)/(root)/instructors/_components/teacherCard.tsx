...
const TeacherCard: React.FC<TeacherCardProps> = ({
  ...
  return (
    <>
      <Card className="group hover:shadow-sm transition bg-slate-800 hover:bg-custom-primary/10 rounded-lg   relative  md:max-w-[460px] ">
          ...
          <div className="p-2 sm:p-3 border w-full h-full flex  flex-col justify-start space-y-2 rounded-lg  ml-1 ">
            {loading ? (
              ...
              <div className="flex  space-x-2">
                ...
                <div className="text-custom-primary  pl-3 sm:pl-4 ">
