            ...
            {quizzes.map((quiz, index) => (
              ...
              >
                {(provided) => (
                  <div
                    className={cn(
                      "flex items-center gap-x-2 bg-slate-800 border-slate-800 border text-slate-400 rounded-md mb-4 text-sm",
                  ...
                  >
                    <div
                      className={cn(
                        "px-2 py-3 border-r border-r-slate-800 hover:bg-slate-900 rounded-l-md transition",
