...
const ChapterIdPage = async ({
  ...
  return (
    <div>
      ...
      <div className="hidden lg:block fixed right-0 top-[80px] bottom-0 w-64 pt-4 space-y-4 md:w-72 bg-gray-900 shadow-lg">
                ...
                <div key={attachment.id}>
                  <div className="pb-2 w-full">
                    <a
                      href={attachment.url}
                      target="_blank"
                      className="flex items-center p-3 w-full border text-slate-300 text-sm font-[500] rounded-md hover:underline transition-all hover:text-input-border hover:bg-slate-300/20"
                    >
                      <File />
