...
const QuizCard = ({ questions, onQuizComplete, quizId, quizTimeline }: QuizCardProps) => {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 bg-slate-800 rounded-2xl shadow-md max-w-md mx-auto min-h-[350px] w-full mt-[140px] md:mt-[100px] lg:mt-[100px] xl:mt-0 z-50 relative">
      {!quizDone && (
        <>
